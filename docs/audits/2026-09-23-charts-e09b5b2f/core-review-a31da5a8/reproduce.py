#!/usr/bin/env python3
"""Run the core-model native probes without modifying workspace manifests."""
import argparse
import json
import os
...
def main():
    ...
    manifest = (
        '[package]\nname="chart-core-native-a31da5a8"\nversion="0.0.0"\nedition="2024"\n'
        '[workspace]\n[dependencies]\n'
    ...
    with tempfile.TemporaryDirectory(prefix="chart-core-native-") as work:
        ...
        log = out / "native.log"
        print(f"Running core probes; output: {log}", flush=True)
