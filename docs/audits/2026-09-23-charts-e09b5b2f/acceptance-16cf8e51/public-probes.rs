...
fn original_findings() {
    ...
    let track = &s
        .marks
        .iter()
        .find(|m| m.key == "main:g:gauge:track")
        .unwrap()
        .geometry;
    let value = &s
        .marks
        .iter()
        .find(|m| m.key == "main:g:gauge:value")
        .unwrap()
        .geometry;
    ...
    println!(
        ...
        s.marks
            .iter()
            .find(|m| m.key == "main:a:radar")
            .unwrap()
            .geometry
            == s.marks
                .iter()
                .find(|m| m.key == "main:b:radar")
                .unwrap()
                .geometry
    );
    ...
    println!(
        ...
        s.marks
            .iter()
            .find(|m| m.key == "main:a:a1")
            .unwrap()
            .geometry,
        s.marks
            .iter()
            .find(|m| m.key == "main:b:b1")
            .unwrap()
            .geometry
    );
